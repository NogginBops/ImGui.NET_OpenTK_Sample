...
public class Rigidbody : Component
{
	...
	public void CreateBody()
	{
		...
		bodyDef.Position = new Vector2(transform.position.X, transform.position.Y) / Physics.WORLD_SCALE;
		...
		else if (GetComponent<BoxShape>() != null)
		{
			...
			float boxHalfWidth = boxShape.size.X * transform.scale.X / 2 / Physics.WORLD_SCALE;
			float boxHalfHeight = boxShape.size.Y * transform.scale.Y / 2 / Physics.WORLD_SCALE;
